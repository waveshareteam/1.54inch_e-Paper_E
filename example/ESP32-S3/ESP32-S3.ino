...
void setup() {
    ...
    Paint_DrawString_CN(10, 120, "你好abc", &Font12CN, EPD_1IN54E_BLACK, EPD_1IN54E_WHITE);
    Paint_DrawString_CN(10, 140, "微雪电子", &Font24CN, EPD_1IN54E_WHITE, EPD_1IN54E_BLACK);
